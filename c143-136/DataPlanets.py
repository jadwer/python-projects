...
## Cómo se debería de manejar una excepción realmente:
# try:
#    x =  10/0
#    print(x)
...
#    print(f"Cuidado!:", err)
#    x=0
#    print("X está dividido por cero, por lo que toma el valor:", x)
...
for planet_data in planet_data_rows:
   ...
   try:
      temp_dict["specifications"] = final_dict.get(int(planet_data[0]))
      final_planet_list.append(temp_dict)
   except Exception as err:
      print(f"{err=}, {type(err)=}")

print(final_planet_list[0])
